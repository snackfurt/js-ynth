...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	function viewcontrols_sampleSize_binding(value) {
    		/*viewcontrols_sampleSize_binding*/ ctx[5](value);
    	}

    	function viewcontrols_oldWavesDisplayed_binding(value) {
    		/*viewcontrols_oldWavesDisplayed_binding*/ ctx[6](value);
    	}

    	function viewcontrols_fps_binding(value) {
    		/*viewcontrols_fps_binding*/ ctx[7](value);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas, file$2, 2, 4, 173);
    			attr_dev(div, "class", "canvasContainer center svelte-zzng2e");
    			add_location(div, file$2, 1, 0, 104);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
