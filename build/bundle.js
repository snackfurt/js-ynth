...
var app = (function () {
    ...
    const file$8 = "src/components/Panel.svelte";
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$8, 3, 12, 91);
    		},
    ...
    class Panel extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$b, create_fragment$b, safe_not_equal, { heading: 1, isOpen: 0, removeHandler: 2 });
    ...
    const file$7 = "src/modules/AudioInput.svelte";
    ...
    function create_default_slot$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$7, 2, 8, 102);
    			attr_dev(label0, "class", "svelte-mkl884");
    			add_location(label0, file$7, 1, 4, 86);
    			attr_dev(input1, "type", "checkbox");
    			add_location(input1, file$7, 6, 8, 220);
    			attr_dev(label1, "class", "svelte-mkl884");
    			add_location(label1, file$7, 5, 4, 204);
    		},
    		m: function mount(target, anchor) {
    ...
    const file$6 = "src/components/Knob.svelte";
    ...
    const file$5 = "src/modules/soundwave/OscillatorControls.svelte";
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$5, 1, 4, 28);
    			attr_dev(div1, "class", "labelContainer svelte-15aqzp1");
    			add_location(div1, file$5, 6, 4, 403);
    ...
    const file$4 = "src/modules/soundwave/SoundGeneratorControls.svelte";
    ...
    function create_label_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$4, 2, 4, 200);
    		},
    		m: function mount(target, anchor) {
    ...
    class SoundGeneratorControls extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$7, create_fragment$7, safe_not_equal, { waveType: 0, frequency: 1, detune: 2 });
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$3, 80, 27, 1828);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    			append_dev(span, t);
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label_1, file$3, 65, 4, 1292);
    			...
    			add_location(button, file$3, 67, 8, 1360);
    			attr_dev(div0, "class", "svelte-1c9ojcg");
    			add_location(div0, file$3, 66, 4, 1346);
    			attr_dev(div1, "class", "container svelte-1c9ojcg");
    			add_location(div1, file$3, 63, 0, 1203);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<Oscilloscope> was created with unknown prop '${key}'`);
    	});
    ...
    class Oscilloscope extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*oldWavesDisplayed*/ ctx[2] === undefined && !('oldWavesDisplayed' in props)) {
    			console_1$1.warn("<Oscilloscope> was created without expected prop 'oldWavesDisplayed'");
    		}
    	}
    ...
    function create_else_block_2(ctx) {
    	...
    	oscilloscope = new Oscilloscope({
    			props: {
    				oldWavesDisplayed: /*oldWavesDisplayed*/ ctx[6]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*oldWavesDisplayed*/ 64) oscilloscope_changes.oldWavesDisplayed = /*oldWavesDisplayed*/ ctx[6];
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(29:0) {#each sounds as sound}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	function viewcontrols_sampleSize_binding(value) {
    		/*viewcontrols_sampleSize_binding*/ ctx[14](value);
    	}

    	function viewcontrols_oldWavesDisplayed_binding(value) {
    		/*viewcontrols_oldWavesDisplayed_binding*/ ctx[15](value);
    	}

    	function viewcontrols_fps_binding(value) {
    		/*viewcontrols_fps_binding*/ ctx[16](value);
    	}

    	let viewcontrols_props = {};

    	if (/*sampleSize*/ ctx[3] !== void 0) {
    		viewcontrols_props.sampleSize = /*sampleSize*/ ctx[3];
    	}

    	if (/*oldWavesDisplayed*/ ctx[6] !== void 0) {
    		viewcontrols_props.oldWavesDisplayed = /*oldWavesDisplayed*/ ctx[6];
    	}

    	if (/*fps*/ ctx[4] !== void 0) {
    		viewcontrols_props.fps = /*fps*/ ctx[4];
    	}
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*errorMessage*/ ctx[7]) return 0;
    		return 1;
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$1, 7, 4, 235);
    			attr_dev(button1, "class", "svelte-p4iq6r");
    			add_location(button1, file$1, 14, 4, 394);
    			attr_dev(button2, "class", "svelte-p4iq6r");
    			add_location(button2, file$1, 21, 4, 549);
    			add_location(div, file$1, 6, 0, 225);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!updating_sampleSize && dirty & /*sampleSize*/ 8) {
    				...
    				viewcontrols_changes.sampleSize = /*sampleSize*/ ctx[3];
    			...
    			if (!updating_oldWavesDisplayed && dirty & /*oldWavesDisplayed*/ 64) {
    				...
    				viewcontrols_changes.oldWavesDisplayed = /*oldWavesDisplayed*/ ctx[6];
    				add_flush_callback(() => updating_oldWavesDisplayed = false);
    			}

    			if (!updating_fps && dirty & /*fps*/ 16) {
    				updating_fps = true;
    				viewcontrols_changes.fps = /*fps*/ ctx[4];
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		init(drawCallback, errorCallback);
